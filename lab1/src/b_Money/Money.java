...
public class Money implements Comparable {
	...
	public Integer universalValue() {
		 ...
		 return (int)(this.amount* currency.getRate().doubleValue());
	...
	return 	(this.currency.getRate()*this.amount) == (other.amount *other.currency.getRate());
	...
	public Money add(Money other) {
		Money addedmoney = new Money(0, this.currency);
	   addedmoney.amount= (int) (this.currency.getRate()*other.amount*other.currency.getRate());
	   
	   addedmoney.amount=this.amount+addedmoney.amount;
	...
	public Money negate() {
	 ...
	 String moneystring = this.getAmount().toString();
	 
	 moneystring="-"+moneystring;
	 
	 int negated = Integer.parseInt(moneystring);
	 
	 Money negate= new Money(negated, this.currency);
	...
	public int compareTo(Object other) {
	 ...
	 Money othercurrency = (Money) other;
	 
		if (this.amount * this.currency.getRate() == othercurrency.amount * othercurrency.currency.getRate()) {
			return 0;
			
		} else if (this.amount * this.currency.getRate() < othercurrency.amount * othercurrency.currency.getRate()) {
